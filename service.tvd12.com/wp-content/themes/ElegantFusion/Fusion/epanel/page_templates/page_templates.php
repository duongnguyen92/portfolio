...
define( 'ET_PT_CSS', get_template_directory_uri() . '/epanel/css' );
...
function et_ptemplates_css(){
	if ( !is_admin() && !(strstr( $_SERVER['PHP_SELF'], 'wp-login.php')) ) {
		...
		wp_enqueue_style( 'bootstrap', ET_PT_CSS . '/bootstrap.min.css', array(), '1', 'screen' );
		wp_enqueue_style( 'agency', ET_PT_CSS . '/agency.css', array(), '1', 'screen' );
		wp_enqueue_style( 'jquery-ui-css', ET_PT_CSS . '/jquery-ui.css', array(), '1', 'screen' );
	}
}
