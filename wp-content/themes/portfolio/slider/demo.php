...
<!--			</div>-->
			<img src="<?php echo get_template_directory_uri() ?>/images/banner-top-head.jpg" class="msDefaultImage" width="1080" height="420" alt="<?php esc_attr_e('Demo Slide', 'vantage') ?>" />
		</li>
